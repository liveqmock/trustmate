			...
			function pwUpdate() {	
				...
				if(frm.uppassword.value == ""){
					...
					if(frm.checkpassword.value == ""){
						alert("Please Input Change Password(check)");
						frm.checkpassword.focus();
					}else{
						if(frm.uppassword.value == frm.checkpassword.value){
							opener.location.href="/merchant/info.do?request=modify&password="+frm.password.value+"&uppassword="+frm.uppassword.value;
							//alert("OK");
							self.close();
						}else{
							alert("The passwd is incorrect. To input again.");
        			...
        			<div class="fields">
        				<div class="field">
							...
							<div class="input" style="padding-left: 50px">
								<input name="password" id="password" type="password" class="text200" maxlength="20" value="" />
							</div>
						</div>
						<div class="field">
							<div class="label">
