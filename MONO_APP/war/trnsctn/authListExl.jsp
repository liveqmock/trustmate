...
<%
	String fileName = "AUTH_"+CommonUtil.getCurrentDate("yyyyMMddHHmmss");
...
<span id="d1">
    <table width="95%" cellpadding="0" cellspacing="1" border="1" bordercolor="#C4D2E7">
	  <tr>
        ...
        <td width="8%" align="center"  class="list_title">인증</td>
        ...
        <td width="10%" align="center"  class="list_title">인증요청일시</td>
        <td width="10%" align="center"  class="list_title">인증응답일시</td>
      </tr>
      <tr>
        <td colspan="14" height="2" bgcolor="#1b6c8e"></td>
      </tr>
      <c:forEach var="list" items="${trnsctnList}" varStatus="status">
      	<tr>
      		...
      		<td align="center" class="list_02">
				<c:choose>
					<c:when test="${list.resultMsg == '0000' }">인증성공</c:when>
					<c:otherwise>인증실패</c:otherwise>
				</c:choose>
			</td>
      		<td align="center" class="list_02">
      			<c:choose>
