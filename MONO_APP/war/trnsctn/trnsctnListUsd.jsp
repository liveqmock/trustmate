...
<script type="text/javascript">
	...
	function view(type, transactionId){
		showloading(false);
		if(type == '1'){
			window.open('/trnsctn.do?request=view&transactionId='+transactionId,'','width=730,height=620,left=100,top=100');
		}else{
		...
		<div id="content">
			...
			<div id="right">				
				...
				<div class="box">
					<!-- box / title -->
					<div class="title">
						<h5><spring:message code="searchPannel" text=""/>거래내역(USD)</h5>
					</div>
					<form name="trnsctnList" action="/trnsctn.do?request=listUsd" method="post">
					<div class="form">
						<div class="fields">
							<div class="field">
								<div class="label">
									...
									<c:when test="${fn:length(trnsctnList) != 0}">
										<c:forEach var="list" items="${trnsctnList}" varStatus="status">
											<tr>
												...
												<td class="list">
													<c:choose>
												      <c:when test="${list.trnStatus == '02' || list.trnStatus == '07' || list.trnStatus == '08' || list.trnStatus == '09' || list.trnStatus == '10' || list.trnStatus == '11' || list.trnStatus == '12' || list.trnStatus == '13'}">
