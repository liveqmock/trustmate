				...
				if(frm.uppassword.value == ""){
					...
					if(frm.checkpassword.value == ""){
						...
						if(frm.uppassword.value == frm.checkpassword.value){
							opener.location.href="/member.do?request=modify2&password="+frm.password.value+"&uppassword="+frm.uppassword.value+"&memberId="+frm.memberId.value;
							//alert("OK");
							self.close();
						}else{
	...
	<body>
		<div id="content">
			<div class="box">
				...
				<div class="form">
				<input type="hidden" name="memberId" value="${mBean.memberId }" />
        			<div class="fields">
        				<div class="field">
							<div class="label">
