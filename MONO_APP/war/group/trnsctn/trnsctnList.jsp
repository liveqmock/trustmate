		...
		<div id="content">
			...
			<div id="right">				
				...
				<div class="box">
					...
					<form name="trnsctnList" action="/group/trnsctn.do?request=list" method="post">
					<div class="form">
						<div class="fields">
							<div class="field">
								<div class="label">
								...
								<div class="input">
									...
									<c:if test="${!empty trnsctnBean.merchantId}"><script>document.trnsctnList.merchantId.value="${trnsctnBean.merchantId}";</script></c:if>
								</div>
								
								<div class="label2">
									<label for="qualification">Currency</label>
								</div>
								<div class="input2">
									<select name="curType">
				                   		<option value="">-----&nbsp;</option>
									...
									<c:if test="${!empty trnsctnBean.curType}"><script>document.trnsctnList.curType.value="${trnsctnBean.curType}";</script></c:if>
								</div>
							</div>
							<div class="field">
								<div class="label">
								...
								<div class="input">
									<input type="text" name="transactionId" id="transactionId" maxlength="12" class="transactionId" value="${trnsctnBean.transactionId}"/>
								</div>
								...
								<c:choose>
									<c:when test="${fn:length(trnsctnList) != 0}">
										<c:forEach var="list" items="${trnsctnList}" varStatus="status">
											<tr>
												...
												<td class="list"><strong>${list.merchantId}</strong></td>
												...
												<td class="list">
													<fmt:formatNumber type="number" value="${list.amount}" pattern="#,##0.00" />
												</td>
									...
									<c:otherwise>
										<tr height="${(50-fn:length(trnsctnList)) * 12}">
								    			<td align="center" class="list" colspan="12">&nbsp;NO RESULT</td>
								    	<tr>
									</c:otherwise>
								</c:choose>
							</tbody>
