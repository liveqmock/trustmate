...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="header">
		...
		<!-- logo -->
		<div id="logo">
			<h1><a href="/group/trnsctn.do?request=listForm" title="PGMS Admin"><img src="${customizingBean.topLogo}" alt="PGMS" /></a></h1>
		</div>
		<!-- end logo -->
		<!-- user -->
		<ul id="user">
		...
		<div id="header-inner">
			<div id="home">
				<a href="/group/main" title="Home"></a>
			</div>
			...
			<ul id="quick">
				<li>
					...
					<ul>
						<li><a href="/group/trnsctn.do?request=listForm">Transaction</a></li>
					</ul>
				</li>
				<li>
					<a href="#" title="member"><span class="normal">MERCHANT</span></a>
					<ul>
						<li class="last"><a href="/group/info.do?request=merchantList">Merchant</a></li>
					</ul>
				</li>	
				<li>
					<a href="#" title="report"><span class="normal">REPORT</span></a>
					<ul>
						<li><a href="/group/report.do?request=invoice">Invoice</a></li>
					</ul>
				</li>
				<%--
				<li>
					<a href="#" title="report"><span class="normal">REPORT</span></a>
					<ul>
						<li><a href="/group/report.do?request=acquireForm">Collect</a></li>
						<li><a href="/group/report.do?request=settlementForm">Paid</a></li>
						<li><a href="/group/report.do?request=invoiceForm">Invoice</a></li>
						<li class="last"><a href="/group/report.do?request=cblistForm">ChargeBack</a></li>
					</ul>
				</li>
				<li>
					<a href="#" title="member"><span class="normal">MERCHANT</span></a>
					<ul>
						<li class="last"><a href="/group/info.do?request=info">Information</a></li>
					</ul>
				</li>	
				 --%>		
			</ul>
