...
<HTML>
	<HEAD>
		...
		<link href="/common/css/statement.css" rel="stylesheet" type="text/css">
		<script src="/common/js/common.js" type="text/javascript"></script>
		<script src="/common/js/iezn_embed_patch-unenfant.js" type="text/javascript"></script>		
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:1 solid #0066CC">
									...
									<tr >
										...
										<table width="740" align="center" border="1" cellpadding="0" cellspacing="0" class="reference">
											...
											<tr>
												<td width="20"  class="td_noemp_num">①</td>
												<td width="345"	class="td_sub_title1">&nbsp;Current Balance</td>
												<td width="125" class="td_noemp_num">&nbsp;</td>
											...
											<tr>
												<td width="20"  class="td_noemp_num">②</td>
												<td width="345"	class="td_sub_title1">&nbsp;Balance of occurred deposit</td>
												<td width="125" class="td_noemp_num"></td>
