...
public class MerchantBean extends GSIBean implements java.io.Serializable{
	...
	private String devPartName		= "";
	private String devPartEMail 	= "";
	private String devPartTelNo		= "";
	...
	public String getDevPartName() {
		return devPartName;
	}

	public void setDevPartName(String devPartName) {
		this.devPartName = devPartName;
	}

	public String getDevPartEMail() {
		return devPartEMail;
	}

	public void setDevPartEMail(String devPartEMail) {
		this.devPartEMail = devPartEMail;
	}

	public String getDevPartTelNo() {
		return devPartTelNo;
	}

	public void setDevPartTelNo(String devPartTelNo) {
		this.devPartTelNo = devPartTelNo;
	}
