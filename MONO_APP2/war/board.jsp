			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getPageContent('/main.do')">DashBoard</a></i>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-2 ">
					<div class="portlet box green">
						...
						<div class="portlet-body" id="todayChart" style="height: 218px;">
						</div>
					</div>
				</div>
				<div class="col-md-5">
				...
				<div class="col-md-5">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Transaction Statistics
							</div>
							<div class="actions">
								
								<a href="javascript:monthlyChartToday('AMOUNT');" class="btn yellow btn-sm"><i class="fa fa-bar-chart-o"></i> AMOUNT</a>
								<a href="javascript:monthlyChartToday('COUNT');" class="btn green btn-sm"><i class="fa fa-bar-chart-o"></i> COUNT</a>
								
								
							</div>
						</div>
						<div class="portlet-body" id="monthlyTodayChart" style="height: 218px;">
