			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Merchant Bill Registration</a>
						</li>
				...
				<div class="col-sm-12">
					...
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Merchant Bill Registration Form
							</div>
							<div class="tools">
								...
								<div class="form-body">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="number" class="form-control text-right" name="deposit" value="0" >
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="20" name="bankCode" value="" >
											</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" maxlength="100" name="branch" >
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" maxlength="20" name="account" value="" >
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" maxlength="100" name="accountHolder" value="" >
												</div>
											</div>
										</div>
									</div>
					...
					<script>
			            ...
			            form1.validate({
			                ...
			                submitHandler: function (form) {
			                    error1.hide();
			                    ajaxFormSubmit('/member.do?request=view&merchantId=${param.merchantId}');	//PAGE 이동
			                }
			            });
