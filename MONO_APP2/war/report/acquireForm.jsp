...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Acquire <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Acquire List</a>
						</li>
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/report.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm temp1String" data-provide="typeahead" name="temp1String" placeholder="Merchant ID" >
										</div>
										<label class="col-sm-2 control-label">Transaction ID</label>
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="trnasactionId" placeholder="Transaction ID">
										</div>
										<label class="col-sm-2 control-label">Status</label>
										<div class="col-sm-2">
											<select class="form-control select2me input-sm" name="active">
												<option value="">-----&nbsp;</option>
												<option value="00">Acquired</option>
											    <option value="11">Acquiring Failed</option>
											    <option value="22">Acquiring Reversed</option>
											    <option value="33">Re/Acquiring</option>
