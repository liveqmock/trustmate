...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<h3 class="page-title">Member <small>Edit Form</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Member Edit Properties</a>
						</li>
				...
				<div class="col-sm-12">
					...
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Member Edit Properties
							</div>
							<div class="tools">
							...
							<form class="form-horizontal form-bordered form-row-stripped" role="form" data-form="true" id="form" name="form" action="/member.do" method="post">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="12" data-required="1" name="memberId" value="${mBean.memberId}" readonly>
													<input name="request" type="hidden" value="mEdit" >
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="20" data-required="1" name="name" value="${mBean.name}" >
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="email" name="officeEmail" maxlength="50" class="form-control" value="${mBean.officeEmail}" >
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="20" placeholder="" name="phoneNo" value="${mBean.phoneNo}" >
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<select name="memberGrade" class="select2me form-control" id="memberGrade">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<select name="notice" class="select2me form-control" id="notice">
								...
								<div class="form-actions right">
									<div class="">
										...
										<a class="btn dark btn-sm" href="javascript:getPageContent('/member.do?request=mview&memberId=${mBean.memberId}');"><i class="fa fa-chevron-left "></i>&nbsp;Prev&nbsp;&nbsp;</a>
					...
					<script>
						//SELECT 정보 설정 
						$("#memberGrade").val("${mBean.memberGrade}");
						$("#active").val("${mBean.active}");
						$("#notice").val("${mBean.notice}");
			            ...
			            form1.validate({
			                ...
			                submitHandler: function (form) {
			                    error1.hide();
			                    ajaxFormSubmit('/member.do?request=mview&memberId=${mBean.memberId}');	//PAGE 이동
			                }
			            });
					</script>
					<!-- END FORM JAVASCRIPT -->
