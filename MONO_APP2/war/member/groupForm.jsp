...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Group <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Group List</a>
						</li>
						<c:if test="${sso.memberRole == '0001' }">
							<li class="btn-group">
								<button type="button" class="btn blue" onclick="getPageContent('/member/groupAddForm.jsp');">
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/member.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="groupId" placeholder="groupId" >
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="glist" >
