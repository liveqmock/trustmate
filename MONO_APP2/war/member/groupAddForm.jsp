			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Group Registration</a>
						</li>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label class="control-label col-sm-4">Group ID<span class="required">*</span>
												</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="20" name="groupId" id="groupId">
													<input name="request" type="hidden" value="gadd" >
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
														<input type="text" class="form-control " value="" name="ceoZipCode" placeHolder="zipcode">
												</div>
												<div class="col-sm-4">
			            ...
			            form1.validate({
			                ...
			                rules: {
			                    groupId: {
			                        ...
			                        required: true,
			                        remote:{
						                url: "/ajax.do?request=checkGroupId", //make sure to return true or false with a 200 status code
						                type: "post",
						                data: {
						                    groupId: function() {
						                        return $("#groupId").val();
