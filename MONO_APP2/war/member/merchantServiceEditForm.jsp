			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Merchant Service Edit Properties</a>
						</li>
				...
				<div class="col-sm-12">
					...
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Merchant Service Edit Properties
							</div>
							<div class="tools">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<p class="form-control-static2">${mngBean.merchantId }</p>
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													...
													<input name="request" type="hidden" value="serviceEdit" >
													<input name="merchantId" type="hidden" value="${mngBean.merchantId}"  id="merchantId">
													<input name="idx" type="hidden" value="${mngBean.idx}" >
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="onceLimit" value="<fmt:formatNumber type="number" value="${mngBean.onceLimit}" pattern="###" />">
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="dayLimit" value="<fmt:formatNumber type="number" value="${mngBean.dayLimit}" pattern="###" />">
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="monthLimit" value="<fmt:formatNumber type="number" value="${mngBean.monthLimit}" pattern="###" />">
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="cardMonthLimit" value="<fmt:formatNumber type="number" value="${mngBean.cardMonthLimit}" pattern="###" />">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="duplicationCount" value="<fmt:formatNumber type="number" value="${mngBean.duplicationCount}" pattern="###" />">
												</div>
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="number" class="form-control" name="tempLimit" value="<fmt:formatNumber type="number" value="${mngBean.tempLimit}" pattern="###" />">
												</div>
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="20" name="vanId" value="${mngBean.vanId }" >
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="email" class="form-control" name="reportEMail" value="${mngBean.reportEMail}">
												</div>
											</div>
										</div>
									</div>
					...
					<script>
				       $("select[name=curType]").val("${mngBean.curType}");
				       $("select[name=van]").val("${mngBean.van}");
				       $("select[name=auth]").val("${mngBean.auth}");
				       $("select[name=dm]").val("${mngBean.dm}");
				       $("select[name=demo]").val("${mngBean.demo}");
