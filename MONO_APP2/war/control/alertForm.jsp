...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">System Alert <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">System Alert List</a>
						</li>
						<li class="btn-group">
							<button type="button" class="btn blue" onclick="getPageContent('/control/alertAddForm.jsp');">
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/manage.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<select class="form-control select2me input-sm" name="alertType">
												<option value="">-----&nbsp;</option>
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm resultMsg" data-provide="typeahead" name="resultMsg" placeholder="Code" >
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="slist" >
