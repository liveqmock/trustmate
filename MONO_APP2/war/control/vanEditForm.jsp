			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">VAN Edit Properties</a>
						</li>
				...
				<div class="col-sm-12">
					...
					<div class="portlet box blue ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Edit Properties
							</div>
							<div class="tools">
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="10" name="van" value="${vanBean.van}">
													<input name="request" type="hidden" value="vanEdit" >
													<input name="idx" type="hidden" value="${vanBean.idx }" >
												</div>
											</div>
										</div>
										<div class="col-sm-8">
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" maxlength="20" name="vanId" value="${vanBean.vanId}">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="10" name="descriptor" value="${vanBean.descriptor}">
												</div>
											</div>
										</div>
										<div class="col-sm-8">
									...
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-6">
													<input type="text" class="form-control" maxlength="20" name="adminId" value="${vanBean.adminId}">
												</div>
											</div>
										</div>
										<div class="col-sm-8">
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" maxlength="30" name="adminPw" value="${vanBean.adminPw}">
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-sm-4">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" maxlength="50" name="url" value="${vanBean.url}">
												</div>
											</div>
										</div>
										<div class="col-sm-8">
					...
					<script>
				        ...
				        $("select[name=status]").val("${vanBean.status}");
