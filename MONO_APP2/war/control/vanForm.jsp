...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jstl/fmt" %>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">VAN <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">VAN List</a>
						</li>
						<li class="btn-group">
							<button type="button" class="btn blue" onclick="getPageContent('/control/vanAddForm.jsp');">
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/manage.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="van" >
										</div>
										<label class="col-sm-2 control-label">VAN_ID</label>
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="vanId" >
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="vanlist" >
