...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Risk <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Risk List</a>
						</li>
						<li class="btn-group">
							<button type="button" class="btn blue" onclick="getPageContent('/control/riskAddForm.jsp');">
