...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">ChargeBack <small>List</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">ChargeBack  List</a>
						</li>
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trnsctn.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="temp2String" placeholder="VAN Transaction ID">
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="cbList" >
