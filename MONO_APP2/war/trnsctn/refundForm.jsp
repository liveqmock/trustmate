...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Refund Data </h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Refund</a>
						</li>
					</ul>
							...
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trnsctn.do" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm temp1String" data-provide="typeahead" name="temp1String" placeholder="merchantId" >
										</div>
										...
										<label class="col-sm-2 control-label">Refund Id</label>
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm voidTransactionId" name="voidTransactionId" placeholder="Refund ID">
										</div>
										<label class="col-sm-2 control-label">Order No.</label>
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm temp5String" name="temp5String" placeholder="Order No.">
										</div>
										<label class="col-sm-2 control-label">Status</label>
										<div class="col-sm-2">
											<select class="form-control select2me input-sm" name="status">
												<option value="">-----&nbsp;</option>
												<option value="00">Canceled &amp; Refunded</option>
												<option value="11">Accept Refund</option>
												<option value="33">Request Refund</option>
												<option value="99">Error on Refund</option>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="rlist" >
