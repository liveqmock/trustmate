...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Transaction <small> AUTH</small></h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javascript:getReloadPage();">Authentication </a>
						</li>
					</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/merchant/trnsctn.do" method="post">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<input id="request" type="hidden" name="request" value="authList" >
											<input id="auth" type="hidden" name="auth" value="Y" >
